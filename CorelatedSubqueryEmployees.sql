...
SELECT FNAME, SALARY,DID
FROM   EMPLOYEES OUTER
WHERE  800 > ( 750);   --CONDITION BECOME TRUE than it goes to select
...
SELECT FNAME,SALARY,DID
FROM EMPLOYEES OUTER
WHERE 800>(750); --true compiler goes to select ,this row will get displayed.
